...
description: "Learn to perform web scraping with Jsoup and make REST API calls using groovy-wslite on Google App Engine, even with networking limitations."
---
